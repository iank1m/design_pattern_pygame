...
class GameFacade:
    def __init__(self):
        self.setup_game()
        self.start_background = pygame.image.load("/Users/san_l/Desktop/OSS-Project_pygame-main/KakaoTalk_Photo_2024-05-16-13-41-02.png")
    ...
    def draw_score(self):
        ...
        text_score = font.render("Score: " + str(self.score), True, (0, 0, 255))  # Use an appropriate color for BLUE
        ...
        text_level = font.render(f"Level: {self.curr_level}", True, (0, 0, 255))  # Use an appropriate color for BLUE
